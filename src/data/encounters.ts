...
const encounters: any = {
  ...
  cave: [
    "The players hear shouting.They see 2d6 dwarves.They are arguing with each other.They are carrying boxes full of gold coins and jewelry.If the players help them, they will give the players a magical axe and a magical ring worth 100 gold coins each.",
    "You see a group of 1d4 giant spiders eating a dead human body.If any of the adventurers get too close, the spiders will attack.",
    "Up ahead, the players see a group of people around a campfire, who look like they are having a party.When the players approach, they will see that it is a group of 2d6 goblins singing and dancing around their campfire, which is made out of bones that they have stolen from nearby graveyards and animal bones that they have collected from nearby caves and forests during their travels throughout this region of the world.",
    ...
    "In the cave, players find a group of 2d6 + 4 mercenaries who are looking for work.They are led by a warrior named 'Big John' and would be willing to fight alongside the players for a price.",
    ...
    "A group of 2d4 orcs are searching the cave for something.They won't attack the players unless provoked.",
    ...
    "The players come to an underground river.In the center of the river is a giant fish skeleton.If players walk through the river, they will be attacked by 2d6 giant eels.",
    "If the party investigates a specific area they will find a troll.The troll is chewing on a bone.",
    "A group of 2d6 men from a nearby village are exploring the caves in hopes of finding treasure.They will ask the players for advice on whether or not to continue deeper into the cave system or turn back.",
    ...
    "Players discover a group of 3d6 goblins who are gathering supplies for their upcoming raid on a nearby village.",
    "The players come across a strange, magical creature inside the cave.The creature is a powerful wizard, and it will grant the players a powerful magical item if they can answer its riddle.",
    "A large lake with trapped giant frogs is in the middle of the cave.In the lake there is a small island that has a single, lonely tree growing on it.In the tree there is a nest with 2d6+ 5 giant eagles that are ready to attack anything that approaches their nest.",
    ...
    "A group of 2d6 bugbears are looting a nearby crypt for treasure.They will attack the players if they catch them snooping around.",
    "A group of drunk dwarves are arguing with each other.",
    "Players find a group of 2d6 bugbears.The bugbears are looking for something valuable and will attack the players if they get too close.",
    ...
    "A group of 2d6 kobolds are looking for bats to eat.They've trapped a giant bat in their cave. They will be disappointed by the goblins next to the bat. They believe that goblins are bats.",
    "The players find a small pond.If they approach, the water will begin to bubble and a group of 4d4 + 2 red caps will emerge and attack the players.",
    ...
    "A group of 1d4 hobgoblins emerge from the entrance of the cave, intent on attacking anyone they see! The hobgoblins are looking for food and will attack the players if they look like they have any.",
    "A group of 1d20 goblins are riding wolves and are looking for food.",
    "A group of 1d6 uruks is being led by the hobgoblin scouts.They are in disarray.They are looking for goblins to eat them.",
    "Players come across a group of 2d6 giant centipedes who are crawling along the walls of the caves.",
    ...
    "If the party investigates a specific area they will find a group of 1d4 goblins.The goblins have captured a wolf.",
    ...
    "Players find a group of 2d4 kobolds who are looking for a lost idol.The kobolds will not attack the players as long as they don't interfere with their mission.",
    ...
    "The players come to a bridge across an underground river.The bridge is covered in blood and human bones.If players cross the bridge, they will be attacked by 2d4 crocodiles.",
    "A group of 2d4 pixies attack the players with an onslaught of arrows.",
    "Players come across a group of 2d6 skeletons.The skeletons are animated by a powerful necromancer and will attack if disturbed.",
    "Players see a group of 1d4 humans fighting over a small treasure.",
    "A group of 2d4 goblins have set up an ambush in the caves.They will try to capture the players and force them to be a part of their gang."
  ],
  city: [
    ...
    "At any time during the day or night, a group of 2d4 + 2 cultists are praying in the street.",
  ...
  crypt: [
    ...
    "Down the hall, a group of 1d4 ghouls attack! They are led by a ghast!",
    ...
    "A group of 1d4 men is passed out on the floor near a barrel of wine.They are members of a traveling theater troupe, and they are drunk after having completed a play in this crypt.A nearby sign reads: 'Tonight: Comedy! 'Luck of the Draw' by Gorgar the Great!'",
    ...
    "The players come across a small cave that is actually a lair for 2d4 + 4 giant lizards.They will attack if the players get too close.",
    "A group of 1d8 wights attack the players.",
    "A group of 4d4 skeletons are dancing around a bonfire.They are celebrating their victory against four mid - level adventurers.They will attack if players get too close.",
    ...
    "A group of 3d6 dwarves wearing red robes are walking down the hall singing songs about killing goblins and ogres and other monsters that live beneath the earth",
    ...
    "The crypt has been occupied by 1d4 + 4 bandits.They are playing cards and eating.",
    "A group of 2d6 + 2 mercenaries are being led by a chaotic leader.The leader has promised them gold if they complete the mission.",
    ...
    "A group of 2d6 + 2 orcs are getting drunk and celebrating a recent victory by telling stories of their glory and past exploits.They will attack if provoked or if they think they can win.",
    ...
    "The players come across a group of 2d4 specters in a crypt.The specters will give the players a magical item if they can help the specters find a lost artifact.",
    ...
    "A group of 2d4 + 2 mercenaries are searching for the tomb of their former captain.They know that the captain is buried in the tomb, but they do not know where the entrance is located.If players help them, they will reward the players with gold and information.",
    "A group of 2d8 bandits are hiding in this room.If the players enter, they will attack.",
    "The party finds a large room with several statues in it.Each one is made of stone and has a strange green glow coming from it.If they touch them, they will be attacked by 2D6 giant frogs.",
    ...
    "The players hear the sound of 1d4 + 1 orcs arguing about whether or not they should kill the captured Halfling.",
    "The players hear the sound of battle coming from a side passage.As they approach, they see a group of 2d4 + 4 bandits fighting a group of 2d4 + 4 wolves.",
  ...
  dungeon: [
    "A group of 3d4 orcs are at a campsite.They are celebrating the death of one of their party and are getting drunk.They will attack if they are attacked, otherwise they will try to sneak away.",
    ...
    "A group of 2d6 + 4 goblins are playing with a ball.They will attack any living thing that gets close to them.",
    ...
    "A party of adventurers are fighting a group of 3d4 orcs.If players approach, they will ask for help fighting the orcs.",
    ...
    "The players stumble upon a camp in which a group of 2d4 + 2 orcs are celebrating their recent victory over a nearby village.They are drunk, celebrating and dancing around the campfire singing songs of their victory.If the players approach, the orcs will attack on sight.",
    ...
    "A group of 2d6 travelers is sitting around a campfire in the middle of the room.They will offer the party food and drink if they need it.",
    "A group of 2d4 + 4 orcs are sitting around a campfire roasting a dead goblin.The orcs will attack if the players get too close.",
    ...
    "The players see a group of 1d4 + 4 Dwarves.If the players approach, the Dwarves will try to sell them a copper bracelet with a silver dragon set in it.It is worth 4 copper pieces.",
    "A group of 3d8 orcs emerge from a room and attack.If they are defeated, 2d8 more will rush out and attack.",
    ...
    "A group of 1d4 + 2 kobolds are celebrating their latest kill.They are drinking and dancing around a bonfire.",
    ...
    "The entrance to the cave is blocked by an iron portcullis with bolted hinges.Three giant scorpions are standing in front of it.They will attack the players if they try to cross the portcullis.",
    "A party of adventurers are fighting a group of 3d4 orcs.If players approach, they will ask for help fighting the orcs.",
    "A group of 2d6 + 8 men argue about whether to go left or right.They are all soldiers from a nearby city.They are trying to rescue the lord's daughter who was kidnapped by hobgoblins.",
    "A group of 2d6 dwarves are making preparations to attack a nearby goblin tribe.They need help getting supplies and they need help with their battle plans.If the party helps them, they will be rewarded with one magical item each.",
    "A group of 2d6 kobolds are playing cards against each other.They will attack the party if they disturb them.",
    "A party of 2d4 + 4 hobgoblins are marching through the tunnel.They are led by a hobgoblin sergeant.",
    "A group of goblins is trying to capture a giant spider for food.",
    "A group of 1d6 + 2 gnolls are fighting against a group of 1d4 hobgoblins over who gets to eat the body of a dead human that is lying in the middle of the room.",
    "A group of 2d6 orcs are fighting over a dead deer.The orcs have been fighting over the deer for several days now, and they are getting tired.",
    "A group of 2d6 goblins are hiding from a group of 2d6 + 2 hobgoblins who are hunting them down and killing them one by one.They will attack any living thing on sight and beg for their lives when they realize they're being rescued from their captors",
    ...
    "A group of 2d4 + 2 soldiers are standing around in a circle.They are talking about the war and about the terrible commanders they have to follow.If the players join in, they will learn that these soldiers are secretly planning a coup d'etat.",
    "A group of 2d6 goblins are searching for food in an underground passage.The goblins are level 1. They attack the players.",
    "A group of 2d6 men are in this room, gambling and drinking wine.They are playing a game where they bet on how many times an elf named 'Bob' will get drunk and pass out.Players can learn about 'Bob' by talking to the men gambling.If players talk to 'Bob', he will tell them that he is an elf and that he isn't drunk - he just has an Elven blood disease and his blood is green!",
    ...
    "A group of 2d6 kobolds are hunting in the caverns, looking for food and treasure.One of the kobolds is a shaman, and has a magical staff that shoots lazer beams at the players.",
    ...
    "The party comes across a group of 2d6 + 2 goblins who are being attacked by 2d6 + 2 kobolds.The goblins are trying to set up a catapult.The goblins are friendly and will help in any way they can.",
    ...
    "The party comes across a group of 2d6 + 2 dwarves who are being attacked by 2d6 + 2 goblins.The dwarves are trying to set up a defensive position in a small passageway.The dwarves are friendly and will help in any way they can.",
    ...
    "A group of 3d4 dwarves are arguing over who has the best beard.They will attack anyone who insults their beards.",
    "A group of 2d6 kobolds are attacking a group of 2d6 goblins.The goblins are level 1. The kobolds are level 2.",
    "A group of 1d10 + 2 mercenaries are sitting around a campfire.They are singing drinking songs and laughing.If anyone approaches, they will attack.",
    ...
    "A group of 1d4 + 4 goblins are digging in a random room.They are looking for treasure."
  ],
  forest: [
    ...
    "The players stumble on a camp.It has 2d6 + 2 goblins who are cooking fish over a raging fire.The goblins will ask for food and will trade for it with the players.The goblins are not very smart and will trade for anything that is shiny or will light on fire.",
    ...
    "A group of 1d4 + 4 knights are on patrol, looking for bandits and thieves.They will escort players to their city if they need help with anything.",
    ...
    "A group of 2d4 orcs and 2d4 hobgoblins are arguing about something.",
    "A group of 1d4 + 2 halflings are wandering through the forest looking for work.If the players offer them work, they will ask them to clear out a nearby cave that has been infested by kobolds.",
    "A group of 1d4 hunters are hunting a large animal.If the players help them, they will give them 1d6 + 2 arrows made from the animal they are hunting.The arrows are magical and will allow players to shoot at range without penalty for 1d4 days after being fired once.The hunters are actually werewolves in disguise.",
    ...
    "A group of 2d4 + 2 elves are hunting in the woods for food or other resources needed by their village or tribe.They will attack if they feel threatened.",
    "The party is attacked by a pack of 2d6 dire wolves.",
    ...
    "A group of 1d4 + 1 humans from a nearby village are hunting for food.They are hunting a deer that is also hunting them.The deer has the ability to cast magic spells and can cast lightning bolt once per day.The deer will flee from the area if it is attacked or if it sustains any damage.",
    "A group of 2d6 men and women, led by a paladin, are traveling through the forest.They are on their way to a nearby village to help the villagers with their problems.",
    "A group of 3d6 humans are sitting around a campfire, talking about their latest trading expedition where they traveled into a nearby forest to trade with a group of gnomes who had set up camp there recently.The humans were set up for a trap when they arrived at the gnome camp, but they managed to get away with some goods anyway because the gnomes were laughing too hard at first to notice what was happening before they got away with some goods.",
    "The party sees a group of 2d6 + 12 centaurs that are hunting game.They will not talk to the party unless they are invited to join the hunt.If they accept, then the centaurs will give them a magic bow that always hits its target with an arrow made of pure gold.It can only be used once per day, but it guarantees a hit and damage roll of 19 or 20 on any target no matter how far away it is or how small it is.",
    "A group of 2d6 orcs are celebrating their victory in battle against the humans and elves by drinking, eating, and laughing together around a campfire.If the players approach, they will invite them to join in on their celebration.",
    "A group of 1d4 + 4 humans are on their way to a nearby village to warn people about an approaching goblin horde.",
    ...
    "A group of 2d6 hunters have been tracking a giant boar for several days, and they will try to capture it alive if at all possible.",
    ...
    "A group of 2d6 humans are gathering wood for a campfire.If the players get too close, they will attack.",
    ...
    "The players hear the sound of glass shattering.They turn and see a human in full plate armor with two glass swords and two glass shields.He is covered in blood and attacking 2d6 wolves.His name is Sir Burd and he is a member of the Order of the Shattered Sword.He wants to join the party and help them slay a dragon.",
    ...
    "A group of 2d4 + 2 orcs is walking down the road nearby.They are on their way to a nearby city to cause mayhem and destruction.They believe by doing so, they will be rewarded with more gold and food.They will attack any player who approaches them or even looks at them funny.",
    ...
    "A group of 3d6 bandits are traveling through the forest, carrying an assortment of weapons and shields and armor that they will trade with players for food or water or whatever they can get from them.",
    ...
    "A group of 1d4 + 1 bandits are hiding in the woods, waiting for a merchant to pass by.They want to ambush and rob him / her.",
    ...
    "A group of 3d4 deer are grazing nearby.",
    "A group of 2d6 dwarves are searching for their king, who was lost during a hunting trip.",
    "A group of 2d6 elves are walking through the forest.They are carrying a bag of supplies.If players approach, they will attack.If players defeat the elves, they will find that the bag contains a treasure chest full of gold coins, gems, and jewelry.The elves were on their way to sell the items to a nearby village.",
    "A group of 2d6 hunters ride in on horseback.The hunters are looking for a group of gnolls that have been terrorizing the town nearby.The gnolls have been attacking the village and kidnapping the villagers.",
    "A group of 1d4 + 1 humans from a nearby village are hunting for food.They are hunting a deer that is also hunting them.The deer has the ability to cast magic spells and can cast lightning bolt once per day.The deer will flee from the area if it is attacked or if it sustains any damage.",
    "A group of 2d6 bandits are setting up camp for the night.They are setting up a fire, sharpening their weapons, and getting ready to eat some food before they go to sleep for the night.",
    "A group of 2d4 + 2 farmers are walking down the trail, singing songs about farming and harvesting grain...",
    "A group of 2d6 + 2 humans are praying and wailing over the body of a fallen comrade.If they are disturbed, they will attack the players.",
    "You see a group of 1d4 + 2 dwarves who have recently been mining here, but they have given up on mining here because the vein of ore has dried up and because they have been attacked by goblins in this area.They will offer their help to players if they choose to help them mine here again.They will also give the players a map that shows where they found the ore vein in this region of the forest - it shows a large section with a huge red X over it that indicates that it has been mined out by this dwarven clan.",
    ...
    "A group of 1d4 + 3 Hobgoblins are on their way to attack a nearby fort.They do not like the soldiers and want to wipe them out.",
    ...
    "A group of 3d4 Halfling thieves are planning a heist on a local village.They will ask the party to help them with the heist.If the party decides to help them with their heist, they will end up getting double - crossed by the halflings and lose all their money and items as well as get arrested by the town guard.",
    ...
    "A group of 6d6 halflings are celebrating their annual halfling festival.",
    ...
    "An old, abandoned well is slowly being covered in moss and ivy.A group of 3d6 + 6 kobolds(mostly level",
  ...
  graveyard: [
    ...
    "A group of 2d6 cultists are praying to their god.They are hoping that their god will answer their prayers and bless them with wealth.",
    "A group of 1d4 + 4 townsfolk are looking for their lost dog, which ran into the graveyard when they were walking it and it got away from them.They are looking for the dog, not for anything else that might be in the graveyard.",
    ...
    "A group of 2d6 + 4 cultists are praying at a tomb that is surrounded by candles.If players approach, they will attack.The cultists are skilled warriors and will use their advantage of surprise to kill as many players as they can before they are defeated.",
    ...
    "A group of 2d6 grave robbers are digging up graves in search of treasure.They are led by a powerful necromancer who has raised an army of zombies and skeleton warriors.They have a magic item that was stolen from the tomb of a lich.If the players reveal this to them, they will attack them for knowing their secret and try to kill them.",
    ...
    "A group of 2d6 + 2 soldiers from a nearby city are out on patrol.They want to know why the party is in their graveyard.",
    ...
    "A group of 2d6 + 2 men are standing around a large bonfire.They are celebrating their victory over an enemy tribe.They will ask if the players want to join in on their celebration, but they will only accept if the players hand over all of their valuables first!",
    ...
    "A group of 1d4 + 1 orcs are standing around a campfire, laughing and celebrating their victory over a nearby village.",
    "A group of 2d6 mercenaries are being led around by a noble lieutenant who is showing them where the tomb is located.The mercenaries are preparing to rob the tomb while the noble is there to make sure they don't kill each other in the process.",
    "A group of 2d4 skeletons are standing in the road, staring at the sky.They don't attack.",
    "A group of 2d6 + 4 ghouls emerge from a nearby crypt and attack everyone nearby.",
    ...
    "A group of 1d6 zombies are carrying a small chest.The chest contains 1d8 gems worth of jewelry.",
    "A group of 2d6 + 2 wights attack.They are being led by a wraith.",
    "You see a group of 1d4 + 4 zombies attacking a nearby village, which has hired a group of mercenaries to protect them(the mercenaries have been hired for 1d10 weeks, and they have 10 troops - each troop has 3 Hit Dice and are armed with short swords and shields).",
    "The smell of cooked meat can be smelled.It smells like someone is having a cookout in the graveyard.",
    "A group of 2d4 zombies are standing in the road, holding hands and singing a song about love and death.They don't attack.",
    "A group of 1d4 + 4 cultists are sacrificing a young woman to their god.If players interfere, the cultists will attack.If players do not interfere, the cultists will succeed in their ritual and a stone golem will spawn and attack them.",
    ...
    "A group of 2d4 + 4 skeletons are staggering towards the party.They are under the control of a wraith that will appear if they are destroyed.",
    "Nymphs are dancing and celebrating something.If the players approach, they will be attacked by 2d4 + 4 hobgoblins.",
    ...
    "You see a group of 1d4 + 3 ghouls hiding in the shadows.They are hoping to ambush anyone who approaches the grave markers.",
    "A group of 1d4 + 3 skeletons are searching for food.They will attack anything that approaches.",
    "Players come across a group of 2d6 wights, who are dancing around a bonfire.If players approach, the wights will attack.",
    "A group of 2d4 + 4 soldiers from a nearby city are out on patrol.They want to know why the party is in their graveyard.They are also looking for the cause of the recent zombie attacks.",
    ...
    "A group of 1d4 + 4 men are looking for a place to party.They are looking for a place to get drunk, get high, and get laid.",
    ...
    "A group of 2d6 ghouls are feasting on the remains of a recently deceased priest.If disturbed, they will attack.",
    ...
    "Players find a group of 3d4 zombies who are talking to each other about their plans to attack the village nearby.They don't know what the players look like so they're not worried about them.",
    "A group of 2d6 zombies shamble out of a nearby graveyard, attracted by the sounds of combat nearby.",
    "A group of 2d6 + 4 skeletons rise up out of the nearby graves and attack everyone nearby.",
    ...
    "A group of 1d6 zombies are carrying a small chest.They will attack anyone who gets close.The chest contains 1d10 + 10 gp worth of gems.",
    "A lich named Lord Xanthar has been raising an army of the undead.He has just raised a group of 3d4 + 2 zombies and is giving them orders.",
    ...
    "A group of 1d4 + 4 zombies are carrying a small chest.The chest contains 1d10 + 10 gp worth of coins."
  ],
  road: [
    ...
    "A group of 2d6 orcs are riding horses and riding along the road, looking for travelers to rob and kill.",
    ...
    "The players find a small shack.Inside, they find the body of a dead man, 2d6 chickens, and 3d4 geese.The chickens and geese are alive.There is also a small, hungry pony in the corner.The pony is extremely friendly and will follow whoever feeds it.",
    "A group of 2d4 farmers are walking along the road.They are going to the nearby town to sell their crops at the market.They will offer to hire the players as mercenaries to protect their crops from bandits.They will offer the players a share of their crop profits as payment if they will agree to protect their crops on their journey to the market and back to their farms after the harvest has been sold at the market.",
    "A group of 4d6 hunters are passing by.They are on their way to the forest.They are carrying bows and arrows.",
    ...
    "A man is standing in the road with a small cage filled with 1d6+ 1 rats.He is trying to sell them to passersby or he is trying to feed them to the caged rats if no one buys them from him.",
    ...
    "A group of 2d4 men - at - arms are on their way to a nearby city.They've been hired to help with the defense of the city walls.",
    ...
    "A group of 1d10 + 2 ogres is walking down the road.They are headed towards the local village, where they plan on killing all the villagers and feasting on their corpses.The players can attack them before they have a chance to do any damage or they can follow them back to their hideout after they have committed their crimes.",
    "A group of men are in the process of hanging a thief from a tree.The men are from a nearby village, and it is their custom to hang thieves from trees as punishment for their crimes.",
    ...
    "A group of 2d6 men and women are on their way to a funeral.They are carrying gifts between them.If you approach, they will demand to know if you are going to the funeral as well.If you say yes, they will invite you to join them, if not, they will threaten you and continue on their way.",
    ...
    "A group of 1d4 + 3 former soldiers are traveling the road, looking for a new place to settle down in.They have left their home kingdom.",
    ...
    "A group of 2d6 men and women carrying a coffin between them.They will ask if anyone is willing to help them bury their friend.If no one is willing to help, they will bury him by the side of the road and continue on their way.",
    "A group of 1d4 + 3 former soldiers are traveling the road, looking for a new place to settle down in.They have left their home kingdom.",
  ...
  tavern: [
    ...
    "A group of 2d6 + 2 old women are discussing which man they like best.",
